...
#define NL_CONSTRAST 0.87		   // 0.3 low ~ 2.0 high
//#define NL_EXPOSURE 1.8   // [toggle] 0.5 dark ~ 3.0 bright
//#define NL_SATURATION 4.0 // [toggle] 0.0 grayscale ~ 4.0 super saturated
//#define NL_TINT vec3(1.0,0.75,0.5) // [toggle] color overlay

/* Terrain lighting */
#define NL_SUN_INTENSITY 2.98   // 0.5 weak ~ 5.0 bright
...
#define NL_END_HORIZON_COL   vec3(0.78, 0.21, 1)
#define NL_DAWN_ZENITH_COL   vec3(0.01, 0.09, 0.2)
#define NL_DAWN_HORIZON_COL  vec3(2, 0.45, 0.1)
#define NL_DAWN_EDGE_COL     vec3(9, 0.60, 0.3)
...
/* Waving */
#define NL_PLANTS_WAVE 0.53   // [toggle] 0.02 gentle ~ 0.4 violent
#define NL_LANTERN_WAVE 0.05   // [toggle] 0.05 subtle ~ 0.4 large swing
#define NL_WAVE_SPEED 0.53      // 0.5 slow wave ~ 5.0 very fast wave
...
#define NL_WATER_TEX_OPACITY 2.7  // 0.0 plain water ~ 1.0 vanilla water texture
...
#define NL_WATER_TINT vec3(0.38, 0.55, 0.65)
...
#define NL_CLOUD2_THICKNESS 1.3
#define NL_CLOUD2_RAIN_THICKNESS 1.3
#define NL_CLOUD2_STEPS 7
#define NL_CLOUD2_SCALE 0.06
#define NL_CLOUD2_SHAPE 0.64
#define NL_CLOUD2_DENSITY 940.5
